                ...
                <div class="my-3">
                  <div class="my-3">
                    ...
                    <form class="user" @submit.prevent="alta">
                      ...
                      <hr>
                      <div class="form-group row">
                        <p class="ml-3">Nombre y número telefónico de una red de apoyo familiar (En caso de emergencia)</p>
                        <div class="col-sm-6 mb-3">
                  ...
                  <div class="my-3">
                    ...
                    <form class="user" @submit.prevent="alta">
                      <div class="form-group row">
                        <div class="col-sm-6 mb-3 mb-sm-0">
                          <input type="text" class="form-control form-control-user" id="matricula"
                            placeholder="Número de empleado" pattern="[0-9]{3,8}" maxlength="8" @keypress="soloNumeros"
                            onkeypress="return event.charCode >= 48 && event.charCode <= 57" v-model="matricula"
                            required>
                        </div>
                        <div class="col-sm-6 mb-3">
                      ...
                      <div class="row justify-content-center">
                        ...
                        <div class="col-md-6 my-3">
                          ...
                          <button class="btn btn-success btn-lg btn-block"
                            :disabled="this.matricula != '' && this.correoInst != '' && this.passUsr != '' && this.passUsrDos != '' && this.nombre != '' && this.aPaterno != '' && this.aMaterno != '' && this.selectedSexo != '' && this.fechaNa != '' && this.telPersonal != '' && this.selectedDivision != '' && this.nomRed != '' && this.telRed != '' && this.validaBtn === true ? this.estadoBtn = flase : this.estadoBtn = true">
                            <i class="fas fas fa-arrow-right"></i> Continuar
                          </button>
